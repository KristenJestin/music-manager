...
const IDENTITY = group("identity", [
  ...
  { field: "titlesort", vorbis: "TITLESORT", id3: "TSOT", mp4: "sonm", level: "C", source: "recording" },
  {
    field: "subtitle",
    vorbis: "SUBTITLE",
    id3: "TIT3",
  ...
  { field: "album", vorbis: "ALBUM", id3: "TALB", mp4: "©alb", level: "R", albumScope: true, source: "release" },
  {
    field: "albumsort",
    vorbis: "ALBUMSORT",
    id3: "TSOA",
  ...
  { field: "discnumber", vorbis: "DISCNUMBER", id3: "TPOS", mp4: "disk", level: "R", source: "medium" },
  {
    field: "totaldiscs",
    vorbis: "DISCTOTAL",
    id3: "TPOS",
...
const CLASSIFICATION = group("classification", [
  ...
  { field: "movement", vorbis: "MOVEMENTNAME", id3: "MVNM", mp4: "©mvn", level: "O", source: "classical works" },
  { field: "movementnumber", vorbis: "MOVEMENT", id3: "MVIN", mp4: "mvi", level: "O", source: "classical works" },
  { field: "movementtotal", vorbis: "MOVEMENTTOTAL", id3: "MVIN", mp4: "mvc", level: "O", source: "classical works" },
  {
    field: "showmovement",
    vorbis: "SHOWMOVEMENT",
...
const ANALYSIS = group("analysis", [
  ...
  { field: "key", vorbis: "KEY", id3: "TKEY", mp4: `${FF}initialkey`, level: "O", source: "local analysis" },
]);
...
const PROVENANCE = group("provenance", [
  ...
  { field: "encodedby", vorbis: "ENCODEDBY", id3: "TENC", mp4: "©too", level: "O", source: "yt-dlp version" },
  {
